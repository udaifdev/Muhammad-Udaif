...
const Project = () => {
    const cardvariant = {
        ...
        visible: {
            opacity: 1,
            y: 0, // animates to its natural position
            transition: {
                duration: 0.2,
                ease: "easeOut"
            }
    ...
    const projects = [
        ...
        },
        {
            ...
            description: "Comprehensive overview of agile methodology and its implementation in software development.",
            liveLink: "https://example.com/agile-sdlc",
            codeLink: "https://github.com/example/agile-sdlc",
        },
        // {
        //     id: 7,
